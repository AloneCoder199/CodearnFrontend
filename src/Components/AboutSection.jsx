    ...
    >
      ...
      <div className="flex-1 space-y-6">
        ...
        <p className="text-lg text-[#0D1B2A] leading-relaxed">
          I’m <span className="font-bold">Alone Coder</span>, a MERN stack
          developer passionate about{" "}
          <span className="text-[#00BCD4] font-semibold">fast</span>,{" "}
          <span className="text-[#FF9800] font-semibold">user-friendly</span>,
          and <span className="text-[#0D1B2A] font-semibold">scalable</span>{" "}
          apps.
        </p>
